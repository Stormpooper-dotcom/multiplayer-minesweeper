...
Or, you can download and extract the zip from [here](https://github.com/Stormpooper-dotcom/multiplayer-minesweeper/archive/refs/tags/v0.1.0-beta/multiplayer-minesweeper-v0.1.0-beta.zip).
